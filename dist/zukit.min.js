(function () {
  ...
  */
  ...
  var _externalData = externalData('zukit_jsdata'),
      ...
      zukitRawColors = _externalData$colors === void 0 ? {} : _externalData$colors;

  var defaultGetColor = '#cc1818';
  var zukitInstanceColors = {}; // Returns one of predefined in SASS files colors

  function getColor(key) {
    var defaultColor = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : defaultGetColor;
  ...
  function getColorGetter(dataKey) {
    var _externalData2 = externalData(dataKey),
        instanceColors = _externalData2.colors;

    if (_$2.isEmpty(instanceColors)) return getColor;
    zukitInstanceColors[dataKey] = _$2.merge({}, zukitRawColors, instanceColors);
    return function (key) {
      var defaultColor = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : defaultGetColor;
      return key === 'all' ? zukitInstanceColors[dataKey] : _$2.get(zukitInstanceColors, [dataKey, key], defaultColor);
    };
  }
  ...
  var _lodash$f = lodash,
      includes$4 = _lodash$f.includes; // Internal dependencies
  ...
  var ZukitDivider = function ZukitDivider(_ref) {
    ...
    var sizeUnit = includes$4(unit, ['px', 'em', 'rem', '%']) ? unit : defaultUnit;
    var sizeValue = toRange(size, 0, 100);
    var style = sizeValue === 0 ? null : {
  ...
  // WordPress dependencies
  var ToggleControl$1 = wp.components.ToggleControl; // Internal dependencies

  var ZukitToggle = function ZukitToggle(_ref) {
    var className = _ref.className,
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, withDivider && /*#__PURE__*/React.createElement(ZukitDivider, {
      ...
      label: simpleMarkdown(label, {
        br: false
      }),
      help: simpleMarkdown(help, {
        br: true
      }),
      checked: !!checked,
      onChange: onChange
  ...
  var _lodash$e = lodash,
      get$5 = _lodash$e.get,
      map$5 = _lodash$e.map,
      isEmpty$5 = _lodash$e.isEmpty,
      isNil$6 = _lodash$e.isNil,
      omitBy = _lodash$e.omitBy,
      pickBy = _lodash$e.pickBy,
      some = _lodash$e.some;
  var __$7 = wp.i18n.__;
  ...
  var ZukitSidebar = function ZukitSidebar(_ref) {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      var label = _ref4.label,
          value = _ref4.value,
          help = _ref4.help;
      return /*#__PURE__*/React.createElement(ZukitToggle, {
        key: panelKey,
        label: label,
        help: help,
        checked: value,
  ...
  var _lodash$d = lodash,
      keys$1 = _lodash$d.keys,
      has$3 = _lodash$d.has,
      get$4 = _lodash$d.get,
      includes$3 = _lodash$d.includes,
      isEmpty$4 = _lodash$d.isEmpty,
      forEach$3 = _lodash$d.forEach,
      omit$1 = _lodash$d.omit,
      reduce$1 = _lodash$d.reduce,
      first = _lodash$d.first,
      castArray$1 = _lodash$d.castArray;
  var __$6 = wp.i18n.__;
    ...
    useEffect$4(function () {
      var infoKeys = reduce$1(moreInfo, function (acc, value) {
        forEach$3(castArray$1(get$4(value, 'depends', [])), function (val) {
          return includes$3(acc, val) ? null : acc.push(val);
        });
        return acc;
      }, []);
  ...
  function toggleOption(toggleData, options, updateOptions) {
    ...
    return map$4(toggleData, function (item, key) {
      return checkDependency(item, options, false, withPath) && /*#__PURE__*/React.createElement(ZukitToggle, {
        key: key,
  ...
  var _lodash$9 = lodash,
      ...
      isNil$4 = _lodash$9.isNil,
      isPlainObject$1 = _lodash$9.isPlainObject,
      forEach = _lodash$9.forEach,
      noop = _lodash$9.noop;
  ...
  var ZukitTable = function ZukitTable(_ref) {
    ...
    var className = _ref.className,
        _ref$css = _ref.css,
        css = _ref$css === void 0 ? 'grid' : _ref$css,
        fixed = _ref.fixed,
        config = _ref.config,
        head = _ref.head,
        body = _ref.body,
    ...
    var isCssGrid = css === 'grid';
    var gridTemplate = isCssGrid ? (_config$template = config === null || config === void 0 ? void 0 : config.template) !== null && _config$template !== void 0 ? _config$template : null : null;
    var colors = getExternalData('info.colors', {}); // check if there are dynamic cells and call the parent handler if any
    ...
    var withStyle = function withStyle(index, style) {
      var rowIndex = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
      var commonStyle = get$2(cellStyle, index);
      var rowStyle = rowIndex === false ? null : getRowStyles(rowIndex, colors);
      if (isNil$4(style) && !rowStyle && !commonStyle) return null;
      return _objectSpread2(_objectSpread2(_objectSpread2({}, commonStyle !== null && commonStyle !== void 0 ? commonStyle : {}), rowStyle !== null && rowStyle !== void 0 ? rowStyle : {}), style !== null && style !== void 0 ? style : {});
    };
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "head",
      style: getRowStyles('head', colors, gridTemplate)
      ...
      className: "body",
      style: getRowStyles(loading ? 0 : 'body', colors, loading ? 0 : gridTemplate)
  ...
  var usePrevious = wp.compose.usePrevious; // log levels (but errors are always shown!):
  //
  ...
  function logWithColors(messages, messageColors) {
    ...
    if (message1.startsWith('!')) color1 = /application|framework/ig.test(message1) ? dcolors.framework : dcolors.alert; // special colors for selected messages
  ...
  function logWithColors2(message) {
    ...
    var _parseWithColors = parseWithColors(stripColorModifiers(message), colors),
  ...
  function log(message) {
    ...
    if (message) {
      ...
      var colors = [colorBy(message, true), dcolors.name, null];
  ...
  function renderComponent(maybeClientId) {
    ...
    var id = (clientId !== null && clientId !== void 0 ? clientId : clientId2) ? withId(clientId !== null && clientId !== void 0 ? clientId : clientId2) : '';
  ...
  function infoInComponent(messageData) {
    var _$castArray3 = _.castArray(messageData),
        ...
        clientId = _$castArray4[1]; // minus - a special sign to skip the function name


    var colorMod = stripColorModifiers(message, true);
    var id = clientId ? withId(clientId) : '';
    var component = componentName(clientId ? 'infoInComponentWithId,infoInComponent' : 'infoInComponent');
    var withName = _.startsWith(message, '-') ? false : component !== '?';
    var spacer = withName || id ? " ".concat(arrowSymbol, " ") : '';
    var info = "".concat(colorMod).concat(withName ? _bold(component) : '').concat(id).concat(spacer).concat(stripColorModifiers(message));
  ...
  function withId(id) {
    return " with ID ".concat(_bold(shortenId(id)));
  }
  ...
  function stripColorModifiers(string) {
    var returnMod = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;

    // minus - a special sign to skip the function name - first remove it
    var str = _.trimStart(string, '-');

    return returnMod ? modRegex.test(str) ? str[0] : '' : str.replace(modRegex, '');
  }

  function colorBy(message) {
    var obsoleteMode = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    var color = dcolors.basic;

    if (!obsoleteMode) {
      // first check special modifiers from which the string can start
      if (message.startsWith('!')) return [dcolors.alert, true, {
        color: dcolors.white,
        bg: dcolors.alert
      }];
      if (message.startsWith('?')) return [dcolors.mount, true, {
        color: dcolors.white,
        bg: dcolors.mount
      }];
      if (message.startsWith('*')) return [dcolors.render, true, {
        color: dcolors.white,
        bg: dcolors.render
      }];
      if (message.startsWith('+')) return [dcolors.info, true, {
        color: dcolors.white,
        bg: dcolors.info
      }];
      if (message.startsWith('#')) return [dcolors.data, true, {
        color: dcolors.white,
        bg: dcolors.data
      }];
  ...
  function getColors() {
    ...
    var main = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : dcolors.basic;

    var _ref3 = _.isArray(main) ? main : [main, false, null],
    ...
    var weightNormal = mainBold ? weightBold : 'font-weight: normal;';
    var padding = 'padding: 0 2px 0 2px;';
    var paddingBg = 'padding: 1px 3px 1px 3px;';
    var rounded = 'border-radius: 3px;';
    var opaque = (_ref5 = mainOpaque !== null && mainOpaque !== void 0 ? mainOpaque : config.colors.opaque) !== null && _ref5 !== void 0 ? _ref5 : {
      color: dcolors.white,
      bg: dcolors.alert
    };
    return {
  ...
  function setOpaqueColors(color) {
    ...
    if (color === 'brown') config.colors.opaque = {
      color: dcolors.white,
      bg: dcolors.data
    };
  ...
  function parseWithColors(message, colors) {
    var _ref6 = colors !== null && colors !== void 0 ? colors : getColors(),
        normal = _ref6.normal,
        bold = _ref6.bold,
        params = _ref6.params,
        accent = _ref6.accent,
        colored = _ref6.colored,
        opaque = _ref6.opaque;
  ...
  function shortenId(props) {
    ...
    var clientId = _.get(props, 'clientId', props);

    var shortened = _.isString(clientId) ? clientId.slice(-4) : 0;
  ...
  function logWasNow(was, now, keys) {
    ...
    var _ref7 = keys.length === 1 ? changedKeys(nowValue, wasValue) : [],
