(function () {
  ...
  */
  ...
  function optionsReducer(options, action) {
    switch (action.type) {
      case 'set':
        ...
        forEach(action.payload, function (value, key) {
  ...
  var ZukitSidebar = function ZukitSidebar(_ref) {
    ...
    var hasDebugActions = !isEmpty(debugActions) && get$1(panels, '_debug.value') === true;
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      initialOpen: false
    }, map(debugActions, function (_ref6, actionKey) {
  ...
  var ZukitSkeleton = function ZukitSkeleton(_ref) {
    ...
    var _useState3 = useState( // create object {action_value: state}
    ...
    var pluginOptionsEdit = !EditComponent ? null : /*#__PURE__*/React.createElement(NoticesContext.Provider, {
      ...
      id: id,
      info: info,
      title: "".concat(info.title, " ").concat(__$1('Settings')),
      options: options,
    ...
    }, /*#__PURE__*/React.createElement("h1", null, info.title), pluginIcon)), pluginOptionsEdit)))), /*#__PURE__*/React.createElement("div", {
  ...
  var ListInput = function ListInput(_ref) {
    ...
    var _useState = useState$1(''),
        ...
        setCurrentItem = _useState2[1]; // convert string value to array if needed
    ...
    return /*#__PURE__*/React.createElement(BaseControl$1, {
      ...
      label: inputLabel || __$3('Enter new item'),
      value: currentItem,
      ...
      isSecondary: true,
      onClick: onAddItem
    }, __$3('Add')), /*#__PURE__*/React.createElement(Button$3, {
      className: "__reset",
      isSecondary: true,
      icon: closeIcon,
      label: __$3('Reset All'),
      onClick: onReset
    })));
  };
