(function () {
  ...
  */
  ...
  var _ = lodash; // Gets JSON data from PHP
  ...
  var ZukitSidebar = function ZukitSidebar(_ref) {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      initialOpen: false
    }, /*#__PURE__*/React.createElement(PanelRow, null, /*#__PURE__*/React.createElement("span", null, __('Version', 'zukit')), /*#__PURE__*/React.createElement("span", null, version)), /*#__PURE__*/React.createElement(PanelRow, null, /*#__PURE__*/React.createElement("span", null, __('Author', 'zukit')), /*#__PURE__*/React.createElement(ExternalLink, {
      href: link
    ...
    }, __('Reset Plugin Options', 'zukit')))), hasActions && /*#__PURE__*/React.createElement(PanelBody, {
      title: __('Actions', 'zukit'),
      initialOpen: true
  ...
  var ZukitSkeleton = function ZukitSkeleton(_ref) {
    ...
    var pluginOptionsEdit = !EditComponent ? null : /*#__PURE__*/React.createElement(NoticesContext.Provider, {
      ...
      id: id,
      info: info,
      title: "".concat(info.title, " ").concat(__$1('Settings', 'zukit')),
      options: options,
  ...
  function renderPage(pageId) {
    ...
    var pageData = externalData("".concat(pageId, "_settings")); // restRouter serves to identify the plugin/theme that currently uses the REST API
    ...
    if (get$3(settings, 'panels') !== undefined) {
      ...
      if (get$3(pageData, 'options.panels') !== undefined) {
        ...
        forEach$3(panels, function (value, key) {
          return set$2(settings, "panels.".concat(key, ".value"), value);
        });
      }
    }
  ...
  function selectOption(value, option, updateOptions) {
    ...
    }, __$2('Reset', 'zukit'))), /*#__PURE__*/React.createElement("p", {
  ...
  var ZukitPanel = function ZukitPanel(_ref) {
    var id = _ref.id,
        ...
        props = _objectWithoutProperties(_ref, ["id", "className", "title", "children"]);
  ...
  var ZukitTable = function ZukitTable(_ref) {
    ...
    var withContent = function withContent(data) {
      if (!isPlainObject$2(data)) return data;
      ...
      return !tooltip ? icon : /*#__PURE__*/React.createElement(Tooltip, {
        text: tooltip
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "head"
    }, head && map$2(head, function (_ref4, cellIndex) {
      ...
      className: "body"
    }, body && map$2(body, function (cells, rowIndex) {
      return /*#__PURE__*/React.createElement("div", {
        className: "row",
        key: rowIndex
      }, map$2(cells, function (_ref5, cellIndex) {
  ...
  var SelectItem = function SelectItem(_ref) {
    ...
    var makeItem = function makeItem(_ref2) {
      ...
      }, pick(additionalProps, buttonPossibleProps)), isFunction$2(transformValue) ? transformValue(value) : value), withLabels && /*#__PURE__*/React.createElement("div", {
    ...
    }) ? options : map$3(options, function (o) {
      return {
        label: upperFirst(o),
        value: o
      };
    ...
    return /*#__PURE__*/React.createElement(ConditionalWrap, {
      ...
      "aria-label": label
    }, beforeItem, recap && makeItem(recapOptions), map$3(selectOptions, makeItem), afterItem));
  };

  // WordPress dependencies
  var _lodash$8 = lodash,
      isArray = _lodash$8.isArray,
      isEmpty$1 = _lodash$8.isEmpty,
  ...
  var messages = {
    duplicate: __$3('Duplicates are not allowed', 'zukit'),
    email: __$3('It does not look like a valid email.', 'zukit'),
    url: __$3('It does not look like a URL.', 'zukit'),
    tel: __$3('It does not look like a phone number.', 'zukit'),
    regex: __$3('It does not look like a valid input.', 'zukit')
  };
  ...
  var ListInput = function ListInput(_ref) {
    ...
    var items = useMemo(function () {
      return isArray(value) ? value : isEmpty$1(value) ? [] : split(value, separator);
    ...
    return /*#__PURE__*/React.createElement(BaseControl$1, {
      ...
      className: "__list"
    }, map$4(items, function (val) {
      return /*#__PURE__*/React.createElement("div", {
        className: "__list-item",
        key: getKey(val)
      }, /*#__PURE__*/React.createElement("span", null, val), /*#__PURE__*/React.createElement(Button$3, {
        className: "__remove",
        isSecondary: true,
        icon: closeIcon,
        label: __$3('Remove', 'zukit'),
        onClick: function onClick() {
    ...
    }, __$3('Modify', 'zukit'))), editMode && /*#__PURE__*/React.createElement("div", {
      className: "components-animate__appear is-from-top __input"
    }, /*#__PURE__*/React.createElement(TextControl, {
      label: inputLabel || __$3('Enter new item', 'zukit'),
      value: currentItem,
      ...
      isSecondary: true,
      onClick: onAddItem
    }, __$3('Add', 'zukit')), /*#__PURE__*/React.createElement(Button$3, {
      className: "__reset",
      isSecondary: true,
      icon: closeIcon,
      label: __$3('Reset All', 'zukit'),
      onClick: onReset
    })));
  };

  var listInput = compose$1([withNoticesContext])(ListInput);
  ...
  var labels = {
    show: __$4('Show Password', 'zukit'),
    hide: __$4('Hide Password', 'zukit'),
    clear: __$4('Clear', 'zukit')
  };
  ...
  var AdvTextControl = function AdvTextControl(_ref) {
    ...
    }), (isPassword || !withoutClear) && /*#__PURE__*/React.createElement(Button$4, {
      className: "__exclude",
