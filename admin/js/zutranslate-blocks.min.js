var zutranslate_blocks = (function (exports) {
  ...
  function updateRawContent(raw, lang, values) {
    ...
    var rawItems = _.reduce(items, function (newRaw, rawItem, index) {
      ...
      if (values[index] !== undefined) blocks[lang] = values[index]; // const withMarkers = _.map(blocks, (text, ln) => marker(del, ln, text));
  ...
  function splitAtts(translatedAtts) {
    return _.split(translatedAtts !== null && translatedAtts !== void 0 ? translatedAtts : '', ',');
  }
  ...
  function joinTranslatedBlocks(blocks, del) {
    var withMarkers = _.map(blocks, function (text, lang) {
      return marker(del, lang, text);
    });

    return _.join([].concat(_toConsumableArray(withMarkers), [marker(del)]), '');
  }
  ...
  function emptyRawContent(itemCount) {
    ...
    var blocks = getTranslatedBlocks(''); // const withMarkers = _.map(blocks, (text, ln) => marker(del, ln, text));
    // const emptyRaw = _.join([...withMarkers, marker(del)], '');

    var emptyRaw = joinTranslatedBlocks(blocks, del);
  ...
  var _wp$element$2 = wp.element,
      ...
      useMemo$1 = _wp$element$2.useMemo;
  var ESCAPE = wp.keycodes.ESCAPE;
  var withSafeTimeout = wp.compose.withSafeTimeout; // Internal dependencies
  var flagPath$1 = getExternalData('location', []);
  var copyPrefix = 'components-zu-copy-control';

  var flagIcon = function flagIcon(option) {
    return /*#__PURE__*/React.createElement("img", {
      src: option.flag ? flagPath$1 + option.flag : emptyGif
    });
  };
  ...
  var CopyControl = function CopyControl(_ref) {
    ...
    var _useState5 = useState(false),
        ...
        isFlashing = _useState6[0],
        setIsFlashing = _useState6[1];

    var buttonRef = useRef$1(null);
    var availableLanguages = filter(options, function (o) {
      return (o === null || o === void 0 ? void 0 : o.value) !== lang;
    });

    var _useState7 = useState(0),
        _useState8 = _slicedToArray(_useState7, 2),
        langIndex = _useState8[0],
        setLangIndex = _useState8[1];
    ...
    var copyValue = useCallback$3(function (fromLang) {
      var func = isFunction(onCopy) ? onCopy : copyRawAttributes;
      var result = func(fromLang, isOverwriteAllowed);
    ...
    var onEscape = useCallback$3(function (event) {
    ...
    var isDisabled = availableLanguages.length === 1;
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      className: copyPrefix
    }, /*#__PURE__*/React.createElement(Button, {
      disabled: isDisabled,
      className: mergeClasses("".concat(copyPrefix, "__action"), {
    ...
    }, /*#__PURE__*/React.createElement(NavigableMenu // ref={ menuContainer }
    , {
      onKeyDown: onEscape
  ...
  var CopyControl$1 = withSafeTimeout(CopyControl);
  ...
  var LangControl = function LangControl(_ref2) {
    ...
    }), /*#__PURE__*/React.createElement(CopyControl$1, {
      lang: lang,
      options: langOptions,
      onCopy: onCopy
    }));
  ...
  function debugChanged(id, name, key, value) {
    var logEmptyValues = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
