var zutranslate_blocks = (function (exports) {
  ...
  // WordPress dependencies
  var _$1 = lodash; // Zukit dependencies
  ...
  var editorLang = supportSession ? getSessionLang() : getExternalData('lang', 'en'); // Create and register Zu Translate store -------------------------------------]
  ...
  var _lodash$3 = lodash,
      ...
      has = _lodash$3.has,
      noop = _lodash$3.noop;
  var select$2 = wp.data.select; // Internal dependencies
  ...
  function setRawAttributes() {
    ...
    var _select = select$2('core/editor'),
  ...
  var withRawEditControl = createHigherOrderComponent(function (BlockEdit) {
    return function (props) {
      ...
      var _select = select$1('core/block-editor'),
          getBlockOrder = _select.getBlockOrder; // 'getBlockOrder' returns all block client IDs in the editor, check if our block is in this list
      ...
      var isEditableBlock = includes(getBlockOrder(), clientId);
      if (!isEditableBlock && activateDebug) Zubug.info("Block [".concat(name, "] with id {").concat(clientId, "} was skipped"));
