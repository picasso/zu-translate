var zutranslate_blocks = (function (exports) {
  ...
  function createRawContent(lang, values, translatedAtts) {
    ...
    var rawItems = emptyRawContent(values.length, false); // _.fill(_.range(0, values.length), '');
  ...
  var editorLang = supportSession ? getSessionLang() : getExternalData('lang', 'en');
  console.log('getSessionLang()', getSessionLang());
  console.log('editorLang', editorLang); // Create and register Zu Translate store -------------------------------------]
    ...
    forEach(supportedAtts, function (selector, attr) {
      if (onlyAtts === null || includes$1(onlyAtts, attr)) {
        ...
        if (rawValue !== undefined) {
          var renderedValue = getLangContent(rawValue, editorLang);
