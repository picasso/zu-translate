var zutranslate_blocks = (function (exports) {
  ...
  // }
  {
    ...
    var editorLang = useOnLangChange(switchRawAttributes); // установить начальные значени RAW аттрибутов при маунтинг
  ...
  var usePrevious$1 = wp.compose.usePrevious;
  var InspectorControls = wp.blockEditor.InspectorControls;
  var _wp$element$2 = wp.element,
      useEffect$2 = _wp$element$2.useEffect,
      useCallback$1 = _wp$element$2.useCallback,
      useRef = _wp$element$2.useRef; // cloneElement, useState, useEffect, useLayoutEffect
  ...
  var BlockEditLang = function BlockEditLang(props) {
    ...
    var forceUpdate = useForceUpdater();
    var editorLang = useOnLangChange(function (lang) {
    ...
    var prevLang = usePrevious$1(qtxLang);
