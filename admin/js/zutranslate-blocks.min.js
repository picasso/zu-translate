var zutranslate_blocks = (function (exports) {
  ...
  var LangControl = function LangControl(_ref2) {
    var title = _ref2.title,
        ...
        additionalProps = _objectWithoutProperties(_ref2, ["title", "lang", "onClick", "withPanel"]);
    ...
    if (withPanel) {
      ...
      Zubug.data({
        titleWithIndicator: titleWithIndicator,
  ...
  var compose$1 = wp.compose.compose; // const { PanelRow, TextControl, Dropdown, Button } = wp.components;

  var _wp$data$1 = wp.data,
      useSelect = _wp$data$1.useSelect,
      withSelect$1 = _wp$data$1.withSelect,
  ...
  function collectAllRelatedBlocks(blocks) {
    return reduce(blocks, function (collected, _ref) {
      ...
      if (innerBlocks.length) {
        var innerIds = collectAllRelatedBlocks(innerBlocks);
        collected.push.apply(collected, _toConsumableArray(innerIds));
      }
  ...
  function switchAllRelatedBlocks(lang, getBlocks, updateBlockAttributes) {
    var clientId = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
    var allBlocks = getBlocks();
    var blockIds = collectAllRelatedBlocks(allBlocks);
    Zubug.data({
      allBlocks: allBlocks,
      blockIds: blockIds
    ...
    blockIds.forEach(function (blockClientId) {
  ...
  var LangControlSetting = function LangControlSetting(_ref2) {
    var getBlocks = _ref2.getBlocks,
    ...
    var _useSelect = useSelect(function (select) {
      ...
      return [title, lang];
        ...
        title = _useSelect2[0],
        lang = _useSelect2[1]; // const blocks = useSelect(select => {
    ...
    var _useState3 = useState(title),
        ...
        setRawTitle = _useState4[1]; // Zubug.data({ rawTitle, editLang, lang2 });
  ...
  var BlockEditLang = function BlockEditLang(props) {
    ...
    var prevLang = usePrevious(qtxLang);
  ...
  var withRawEditControls = createHigherOrderComponent$1(function (BlockEdit) {
    return function (props) {
      var name = props.name;
      return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(BlockEdit, props), isSupported(name) && /*#__PURE__*/React.createElement(BlockEditLang, props));
    };
  }, 'withRawEditControls'); // export default compose([

  // WordPress dependencies
  var _lodash$3 = lodash,
      isNil$1 = _lodash$3.isNil,
      assign = _lodash$3.assign; // const { __ } = wp.i18n;
  ...
  var _wp$data$2 = wp.data,
      select = _wp$data$2.select,
      subscribe = _wp$data$2.subscribe; //
