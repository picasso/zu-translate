var zutranslate_blocks = (function (exports) {
  ...
  function setRawAttributes() {
    ...
    var _dispatch2 = dispatch(ZUTRANSLATE_STORE),
        ...
        setLang = _dispatch2.setLang;

    var lang = getEditedPostAttribute('editor_lang');
    setLang(lang);
  ...
  var LangControlSetting = function LangControlSetting(_ref) {
    ...
    var editorLang = useOnLangChange(switchRawAttributes); // set the initial RAW attributes on mounting the component
