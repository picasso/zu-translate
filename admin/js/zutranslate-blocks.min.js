var zutranslate_blocks = (function (exports) {
  ...
  function storeReducer() {
    ...
    debug$3.data({
      ...
      value: value,
      prev: state,
      state: hasChanged ? interim : 'same as the previous'
    }, hasChanged ? 'effective change' : undefined);
  ...
  function completedTracking() {
    ...
    Zubug.info("-!watched=".concat(watched.length));
    if (watched.length > 5) Zubug.data({
      watched: watched
    });
  ...
  function resetEdits() {
    ...
    debugPostStatus('{resetEdits}', {
      nonTransientEdits: keys$1(nonTransientEdits)
    });
  ...
  function emulateSavingPost(postEdits) {
    ...
    debug$2.info('-*Emulate {Saving Post}', postId, nonTransientEdits);
