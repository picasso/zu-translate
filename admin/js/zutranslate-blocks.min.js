var zutranslate_blocks = (function (exports) {
  ...
  var LangControlSetting = function LangControlSetting(_ref) {
    ...
    var editorLang = useOnLangChange(switchRawAttributes); // combine two functions for updates to one
  ...
  var BlockEditLang = function BlockEditLang(props) {
    ...
    var onChangeLang = useCallback(function (lang) {
      ...
      forceUpdate();
      syncBlocks(id);
      Zubug.info("{".concat(id, "} Language switched to [").concat(prevLang, " -> ").concat(lang, "]"));
    }, [forceUpdate]);
