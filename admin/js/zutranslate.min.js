(function () {
	...
	var _wp$zukit$utils = wp.zukit.utils,
	    ...
	    getExternalData$1 = _wp$zukit$utils.getExternalData,
	...
	var getExternalData = wp.zukit.utils.getExternalData;
	...
	var ZutranslateConvert = function ZutranslateConvert(_ref) {
	  ...
	  var closeLinkUI = useCallback(function () {
	    setIsOpen(false); // setSelectedId(0);
	  }, []);
	  var convertPost = useCallback(function () {
	    ...
	    ajaxAction({
	      ...
	      return data !== null && data !== void 0 ? data : false;
	    } //setMenuOptions(data)
	    );
