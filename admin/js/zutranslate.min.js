(function () {
	...
	var options = {
	  ...
	  appearance: {
	    label: __$1('Custom button appearance', 'zu-translate'),
	    help: __$1('Change the appearance of the buttons for language switching in admin mode.', 'zu-translate')
	  },
	  large: {
	    label: __$1('Large custom button size', 'zu-translate'),
	    help: __$1('Enlarge the size of the buttons (*for those who prefer more*).', 'zu-translate'),
	    depends: 'appearance'
	  },
	  list: {
	    label: __$1('Add "Language Switcher" to post/pages list', 'zu-translate'),
	    help: __$1('Ability to switch language on a list of posts/pages and support for **Quick Edit**.', 'zu-translate')
	...
	var gutenberg$1 = {
	  ...
	  session: {
	    label: __$1('Support session language', 'zu-translate'),
	    help: __$1('During one session, language switching on different pages will be synchronized.', 'zu-translate')
	  },
	  unsaved: {
	    label: __$1('Switch without changes', 'zu-translate'),
	    help: __$1('Do not consider language switching as **unsaved** changes for the current edit session.', 'zu-translate')
	  },
	  nobackups: {
	    label: __$1('Remove Block Editor "backups"', 'zu-translate'),
	    help: __$1('Removes Wordpress *autosaves* and *backups* notices which could be very annoying.\nYou should understand what you are doing.', 'zu-translate')
	  },
	  custom: {
	...
	var _wp$zukit$components = wp.zukit.components,
	    ...
	    ZukitPanel$1 = _wp$zukit$components.ZukitPanel,
	    AdvTextControl = _wp$zukit$components.AdvTextControl,
	    ListInputControl = _wp$zukit$components.ListInputControl;
	...
	var ZutranslateBlockEditor = function ZutranslateBlockEditor(_ref) {
	  ...
	  return /*#__PURE__*/React.createElement(ZukitPanel$1, {
	    ...
	    options: options,
	    initialOpen: true
	  }, toggleOption$1(pick(data, ['sync', 'session', 'unsaved', 'nobackups']), beOptions, updateBEOptions), /*#__PURE__*/React.createElement("h3", {
	  ...
	  })), hasCustomBlocks && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(ZukitDivider, {
	    bottomHalf: true,
	    size: 2
