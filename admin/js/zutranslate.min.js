(function () {
	...
	var convert = {
	  convertLabel: __$2('Convert Classic Blocks', 'zu-translate'),
	  convertHelp: __$2('Convert all **Classic Blocks** to Gutenberg blocks. Regular text will be replaced with `core/paragraph`, headings with `core/heading` and shortcodes with `core/shortcode` blocks.', 'zu-translate'),
	  convertAction: __$2('Convert', 'zu-translate'),
	  convertTitle: __$2('Select options for conversion', 'zu-translate'),
	  convertTypeLabel: __$2('Select a type for conversion', 'zu-translate'),
	  convertOnlySelected: __$2('Convert only selected posts', 'zu-translate'),
	  convertSelect: __$2('Select the %s for conversion', 'zu-translate'),
	  splitLabel: __$2('Split Classic Blocks', 'zu-translate'),
	  splitHelp: __$2('All **Classic Blocks** found will be split by languages and the contents of the block for each language will be converted to the `Gutenberg` blocks and will be saved in a separate document.', 'zu-translate'),
	  splitAction: __$2('Split', 'zu-translate'),
	  splitTitle: __$2('Select options for split', 'zu-translate'),
	  splitTypeLabel: __$2('Select a type for split', 'zu-translate'),
	  splitOnlySelected: __$2('Split only selected posts', 'zu-translate'),
	  splitSelect: __$2('Select the %s for split', 'zu-translate'),
	...
	var ZutranslateBlockEditor = function ZutranslateBlockEditor(_ref) {
	  ...
	  var beOptions = get$1(options, blockEditorKey, {});
	...
	var convertIcon = 'superhero';
	var splitIcon = 'star-half';
	...
	var ZutranslateConvert = function ZutranslateConvert(_ref) {
	  ...
	  var _useState3 = useState('convert'),
	      _useState4 = _slicedToArray(_useState3, 2),
	      action = _useState4[0],
	      setAction = _useState4[1];

	  var isConvert = action === 'convert';
	  var dataRef = useRef({
	    types: null,
	    posts: null
	  });
	  ...
	  var _useState5 = useState(0),
	      _useState6 = _slicedToArray(_useState5, 2),
	      postType = _useState6[0],
	      setPostType = _useState6[1];

	  var _useState7 = useState(''),
	      _useState8 = _slicedToArray(_useState7, 2),
	      selectLabel = _useState8[0],
	      setSelectLabel = _useState8[1];

	  var _useState9 = useState(false),
	      _useState10 = _slicedToArray(_useState9, 2),
	      onlySelected = _useState10[0],
	      setOnlySelected = _useState10[1];
	  ...
	  var _useState13 = useState((_find = find(enabledLangs, ['active', true])) === null || _find === void 0 ? void 0 : _find.value),
	      _useState14 = _slicedToArray(_useState13, 2),
	      primaryLang = _useState14[0],
	      setPrimaryLang = _useState14[1];

	  var anchorConvertRef = useRef(null);
	  var anchorSplitRef = useRef(null);
	  ...
	  var selectPostLabel = isConvert ? data.convertSelect : data.splitSelect;
	  var selectPostType = useCallback(function (value) {
	    ...
	    setPostType(value);
	    setSelectLabel([sprintf(selectPostLabel, label), sprintf(__('Select %s', 'zu-translate'), label)]);
	  ...
	  var openLinkUI = useCallback(function (action) {
	    setIsOpen(!isOpen);
	    setAction(action);
	  }, [isOpen]);
	  ...
	  var convertPost = useCallback(function () {
	    setIsOpen(false);
	    ajaxAction({
	      action: "zutranslate_".concat(action, "_classic"),
	      value: {
	  ...
	  var anchorRect = (_get = get(isConvert ? anchorConvertRef : anchorSplitRef, 'current')) === null || _get === void 0 ? void 0 : _get.getBoundingClientRect();
	  return /*#__PURE__*/React.createElement(ZukitSidebar.MoreActions, null, /*#__PURE__*/React.createElement(ZukitSidebar.ActionButton, {
	    ...
	    onClick: function onClick() {
	      return openLinkUI('convert');
	    },
	    label: data.convertLabel,
	    help: data.convertHelp,
	    ref: anchorConvertRef
	  }), /*#__PURE__*/React.createElement(ZukitSidebar.ActionButton, {
	    color: "gold",
	    icon: splitIcon,
	    onClick: function onClick() {
	      return openLinkUI('split');
	    },
	    ...
	    icon: isConvert ? convertIcon : splitIcon
	  }), /*#__PURE__*/React.createElement("span", null, isConvert ? data.convertTitle : data.splitTitle), /*#__PURE__*/React.createElement(Button, {
	    className: "__close",
	    icon: closeIcon,
	    onClick: closeLinkUI
	  })), /*#__PURE__*/React.createElement("div", {
	  ...
	  }), isConvert && /*#__PURE__*/React.createElement(SelectControl, {
	    className: "__lang",
