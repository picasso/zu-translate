(function () {
	...
	var ZutranslateBlockEditor = function ZutranslateBlockEditor(_ref) {
	  ...
	  var beOptions = get(options, blockEditorKey, {}); // const excludedBlocks = get(beOptions, 'excluded', []);

	  var sync = beOptions.sync,
	      excludedBlocks = beOptions.excluded,
	  ...
	  return /*#__PURE__*/React.createElement(ZukitPanel$1, {
	    ...
	    options: options,
	    initialOpen: true
	  }, toggleOption$1(pick(data, ['sync', 'session']), beOptions, updateBEOptions), /*#__PURE__*/React.createElement(ToggleControl, {
